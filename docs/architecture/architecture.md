...
- Validator rules coverage:
  - Deployment (GR-012, DA-001), movement bounds/impassable (GR-018, GR-032, DA-004), action limits (GR-015–GR-017), LoS/Range/Cover (GR-021.1, GR-022, DA-005), reroll caps (GR-045, DA-018), optional rules toggles (GR-040–GR-042).
